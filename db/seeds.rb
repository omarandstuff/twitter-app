first_user = User.create!(name: 'david', email: 'david@tweeter.com', password: '12345678')
second_user = User.create!(name: 'david', email: 'omar@tweeter.com', password: '12345678')
