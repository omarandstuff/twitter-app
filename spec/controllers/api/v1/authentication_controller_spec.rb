...
describe Api::V1::AuthenticationController, type: :request do
  describe 'POST #log_in' do
    describe 'when providing right credentials' do
      it 'returns the user' do
        ...
        post '/api/v1/log_in', params: { authentication: { email: 'david@twitter.com', password: 'secret' } }, headers: { 'ACCEPT' => 'application/json' }
    ...
    describe 'when providing guffy token' do
      it 'returns the user' do
        ...
        post '/api/v1/log_in', params: { authentication: { token: user.id } }, headers: { 'ACCEPT' => 'application/json' }
        expect(response).to render_template('api/v1/authentication/log_in')
      end
    end
    ...
    describe 'when providing wrong credentials' do
      it 'returns bad request' do
        ...
        post '/api/v1/log_in', params: { authentication: { email: 'david@tango.io', password: 'bad' } }, headers: { 'ACCEPT' => 'application/json' }
  ...
  describe 'POST #sign_up' do
    describe 'when providing good data' do
      it 'returns the user' do
        post '/api/v1/sign_up', params: { authentication: { name: 'david', email: 'david@twitter.com', password: 'secret' } }, headers: { 'ACCEPT' => 'application/json' }
    ...
    describe 'when providing wrong credentials' do
      it 'returns bad request' do
        post '/api/v1/sign_up', params: { authentication: { name: '' } }, headers: { 'ACCEPT' => 'application/json' }
